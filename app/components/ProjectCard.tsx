...
export default function ProjectCard({ project }: ProjectCardProps) {
  const fundingProgress = project.numMilestones > 0 ? (project.fundedAmount / (project.numMilestones * 10)) * 100 : 0; // Rough estimate
    ...
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="text-center">
          <div className="text-2xl font-bold text-green-600">{project.fundedAmount.toFixed(2)}</div>
          <div className="text-xs text-gray-500">SOL Funded</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-600">{project.kwhTotal}</div>
