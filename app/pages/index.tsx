  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Active Projects</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg shadow">
              ...
              <p className="text-gray-600 mb-6">Be the first to create a renewable energy project!</p>
              <Link
                href="/create-project"
