  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (const milestone of milestones) {
        if (!milestone.amountLamports || !milestone.kwhTarget || !milestone.co2Target || !milestone.payee) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Set up a renewable energy project with milestone-based funding goals.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                <label htmlFor="governanceAuthority" className="block text-sm font-medium text-gray-700">
              ...
              <div>
                <label htmlFor="oracleAuthority" className="block text-sm font-medium text-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleMilestoneChange(index, 'amountLamports', e.target.value)}
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
                        placeholder="10.0"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleMilestoneChange(index, 'kwhTarget', e.target.value)}
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
                        placeholder="1000"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleMilestoneChange(index, 'co2Target', e.target.value)}
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
                        placeholder="400"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleMilestoneChange(index, 'payee', e.target.value)}
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
